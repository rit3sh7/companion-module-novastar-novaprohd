...
// NovaPro HD INPUTS
instance.prototype.CHOICES_NOVAPROHDINPUTS = [
	{ id: '0', label: 'SDI' },
	{ id: '1', label: 'DVI' },
	{ id: '2', label: 'HDMI' },
	...
	return [
		{
			...
			width: 12,
			label: 'Information',
			value: 'This module will connect to a NovaStar NovaProHD LED Processor.'
		},
		{
			type: 'textinput',
			id: 'host',
	...
	self.system.emit('instance_actions', self.id, {
		...
		// Change Brightness for eberything
	  	...
	  	// Disaply mode
			...
			/*//PIP on off NovaPro HD
				  'pip_onoff_NovaproHD': {
			 		 label: 'NovaPro HD PIP On or Off',
		    		options:
						[
							{
								type: 'dropdown',
		...
		//NovaPro HD  INPUTs selection
				'change_novaprohdinputs': {
					label: 'NovaPro HD Inputs',
					options:
					[
						{
							type: 'dropdown',
							...
							id: 'novaprohd_inputs',
							default: '0',
							choices: self.CHOICES_NOVAPROHDINPUTS
						}
					]
				},
...
instance.prototype.action = function(action) {
	...
	case 'change_TP':
		...
		break;
			...
			// change inputs for NOVAPRO HD
			case 'change_novaprohdinputs':
				switch(options.novaprohd_inputs) {
					case '0':
						//SDI               55   AA   00   2B   FE   00   00   00   00   00   01   00   22   00   20   02   01   00   1A   DE   56
						cmd = new Buffer([0x55,0xAA,0x00,0x2B,0xFE,0x00,0x00,0x00,0x00,0x00,0x01,0x00,0x22,0x00,0x20,0x02,0x01,0x00,0x1A,0xDE,0x56]);
						break;
					case '1':
						//DVI               55   AA   00   34   FE   00   00   00   00   00   01   00   22   00   20   02   01   00   1C   E9   56
						cmd = new Buffer([0x55,0xAA,0x00,0x34,0xFE,0x00,0x00,0x00,0x00,0x00,0x01,0x00,0x22,0x00,0x20,0x02,0x01,0x00,0x1C,0xE9,0x56]);
						break;
					case '2':
						//HDMI              55   AA   00   3F   FE   00   00   00   00   00   01   00   22   00   20   02   01   00   1B   F3   56
						cmd = new Buffer([0x55,0xAA,0x00,0x3F,0xFE,0x00,0x00,0x00,0x00,0x00,0x01,0x00,0x22,0x00,0x20,0x02,0x01,0x00,0x1B,0xF3,0x56]);
						break;
					case '3':
						//DP                55   AA   00   51   FE   00   00   00   00   00   01   00   22   00   20   02   01   00   1E   08   57
						cmd = new Buffer([0x55,0xAA,0x00,0x51,0xFE,0x00,0x00,0x00,0x00,0x00,0x01,0x00,0x22,0x00,0x20,0x02,0x01,0x00,0x1E,0x08,0x57]);
						break;
					case '4':
						//VGA               55   AA   00   48   FE   00   00   00   00   00   01   00   22   00   20   02   01   00   17   F8   56
						cmd = new Buffer([0x55,0xAA,0x00,0x48,0xFE,0x00,0x00,0x00,0x00,0x00,0x01,0x00,0x22,0x00,0x20,0x02,0x01,0x00,0x17,0xF8,0x56]);
						break;
					case '5':
						//CVBS              55   AA   00   5A   FE   00   00   00   00   00   01   00   22   00   20   02   01   00   02   F5   56
						cmd = new Buffer([0x55,0xAA,0x00,0x5A,0xFE,0x00,0x00,0x00,0x00,0x00,0x01,0x00,0x22,0x00,0x20,0x02,0x01,0x00,0x02,0xF5,0x56]);
						break;
				  }
				break;
